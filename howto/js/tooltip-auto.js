...
backgroundImage.src = $('#dash-auto').css('background-image').replace(/"/g, "").replace(/url\(|\)$/ig, "");
...
backgroundImage.onload = function () {
    ...
    setPos("dash-dashboard", 0.35, 0.7);
    setPos("dash-steering", 0.35, 0.4);
    setPos("dash-pedals", 0.8, 0.6);
    setPos("dash-gear", 0.57, 0.91);
};
